...
global $CFG;
require_once($CFG->dirroot . '/filter/texwjax/filter.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class filter_texwjax_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $this->filter = new filter_texwjax(context_system::instance(), array());
    }
